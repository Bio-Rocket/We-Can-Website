...
<div class="page">
    ...
    <!-- Hero Section -->
    <section
        class="relative bg-gradient-to-b from-surface-700 via-surface-800 to-surface-900 overflow-hidden min-h-screen flex items-center justify-center"
    >
        <div
        ...
        <div class="relative z-10 max-w-[1200px] mx-auto px-4 md:px-12 py-8 w-full box-border">
            <div class="mb-10">
                <h1 class="text-8xl font-bold text-white mt-2 mb-3.5">Proteus</h1>
                <div class="w-full md:w-[380px] h-[3px] bg-primary-500"></div>
            </div>
            <p class="text-base md:text-lg leading-7 text-white/80 max-w-3xl">
    ...
    >
        <div class="relative z-10 max-w-[1200px] mx-auto px-4 md:px-12 py-8 md:py-10 w-full box-border">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-[2px] bg-primary-700/40">
                <div class="bg-surface-900 p-6 flex flex-col gap-1
    ...
    <section class="page min-h-screen py-20 bg-surface-900 overflow-hidden hero-section relative min-h-screen flex items-center justify-center overflow-hidden">
        <div class="max-w-6xl mx-auto px-2">
            <h2 class="text-7xl font-bold text-[--base-font-color] mb-32 text-center">
                Architecture
            </h2>
